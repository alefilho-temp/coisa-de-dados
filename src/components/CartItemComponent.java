...
public class CartItemComponent extends HBox {
    ...
    private CartDAO cart; // Referência a DAO de cart
        ...
        public CartItemComponent(CartView cartView, CartItemModel item) {
            ...
            removeButton.setOnAction(event -> {
                try {
                    ...
                    e.printStackTrace();
                } // Chama o método para decrementar a quantidade
            });
        ...
        * @throws Exception 
        */
    private void incrementQuantity() throws Exception {
        try {
        ...
        cart.alterarQuantidade(item.getQuantity(), item.getProduct().getId());
    }
     ...
     * Remove o item do carrinho se a quantidade chegar a zero.
          * @throws Exception 
          */
         private void decrementQuantity() throws Exception {
        try {
            cart = new CartDAOImpl();
        } catch (Exception e) {
            e.printStackTrace();
