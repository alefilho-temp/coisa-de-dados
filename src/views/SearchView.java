...
public class SearchView extends ContainerComponent {
     ...
     */
    public SearchView(String search, SearchType type, int id) {
        ...
        if (type == SearchType.category) {
            try {
                products = ProductsQueries.getProdutosCategoria(id);
            } catch (Exception e) {
        ...
        if (type == SearchType.seller) {
            try {
                products = ProductsQueries.getProdutosNomeLoja(search);
            } catch (Exception e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
        ...
        if (type == SearchType.name) {
            try {
                products = ProductsQueries.getProdutosNome(search);
            } catch (Exception e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
